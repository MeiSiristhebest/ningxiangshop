package com.ningxiang.shop.search.config;
...
import com.ningxiang.shop.search.canal.NingxiangCanalBinLogEventParser;
import com.ningxiang.shop.search.canal.NingxiangCanalBinlogEventProcessorFactory;
import com.ningxiang.shop.search.canal.NingxiangCanalGlue;
...
public class CanalGlueAutoConfiguration implements SmartInitializingSingleton, BeanFactoryAware {
    ...
    public CanalBinlogEventProcessorFactory canalBinlogEventProcessorFactory() {
        return NingxiangCanalBinlogEventProcessorFactory.of();
    }
    ...
    public CanalBinLogEventParser canalBinLogEventParser() {
        return NingxiangCanalBinLogEventParser.of();
    }
    ...
    public CanalGlue canalGlue(CanalBinlogEventProcessorFactory canalBinlogEventProcessorFactory) {
        return NingxiangCanalGlue.of(canalBinlogEventProcessorFactory);
    }
