 ...
 */
public class NingxiangCanalBinlogEventProcessorFactory implements CanalBinlogEventProcessorFactory {
    ...
    private NingxiangCanalBinlogEventProcessorFactory() {
    }

    public static NingxiangCanalBinlogEventProcessorFactory of() {
        return new NingxiangCanalBinlogEventProcessorFactory();
    }
}
