 ...
 */
public class NingxiangCanalBinLogEventParser implements CanalBinLogEventParser {
    ...
    private NingxiangCanalBinLogEventParser() {
    }

    public static NingxiangCanalBinLogEventParser of() {
        return new NingxiangCanalBinLogEventParser();
    }
}
