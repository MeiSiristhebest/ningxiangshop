package com.ningxiang.shop.search.canal;
 ...
 */
public class NingxiangCanalGlue implements CanalGlue {
    ...
    private NingxiangCanalGlue(CanalBinlogEventProcessorFactory canalBinlogEventProcessorFactory) {
        this.canalBinlogEventProcessorFactory = canalBinlogEventProcessorFactory;
    }

    public static NingxiangCanalGlue of(CanalBinlogEventProcessorFactory canalBinlogEventProcessorFactory) {
        return new NingxiangCanalGlue(canalBinlogEventProcessorFactory);
    }
}
