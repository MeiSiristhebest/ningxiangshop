package com.ningxiang.shop.search.manager;

import cn.hutool.core.collection.CollectionUtil;
import cn.hutool.core.util.ArrayUtil;
import cn.hutool.core.util.StrUtil;
import com.ningxiang.shop.api.vo.*;
import com.ningxiang.shop.api.vo.search.*;
...
import com.ningxiang.shop.search.constant.*;
...
public class ProductSearchManager {
    ...
    public List<SpuSearchVO> list(ProductSearchDTO productSearchDTO) {
        ...
        try {
            ...
            throw new NingxiangException("搜索服务出了点小差，请稍后再试", e);
        }
        return spuList;
    }
