package com.ningxiang.shop.api.product.manager;
...
import com.ningxiang.shop.api.product.dto.ShopCartItemDTO;
...
import com.ningxiang.shop.api.product.vo.SpuAndSkuVO;
...
import com.ningxiang.shop.common.util.BooleanUtil;
    ...
    public List<ShopCartVO> conversionShopCart(List<ShopCartItemVO> shopCartItems){
        ...
        for (Long shopId : shopCartMap.keySet()) {
            ...
            if (!shopNameResponse.isSuccess()) {
                throw new NingxiangException(shopNameResponse.getMsg());
            }
