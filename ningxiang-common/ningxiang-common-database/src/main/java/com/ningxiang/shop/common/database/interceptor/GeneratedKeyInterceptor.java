package com.ningxiang.shop.common.database.interceptor;

import com.ningxiang.shop.api.leaf.feign.SegmentFeignClient;
import com.ningxiang.shop.common.database.annotations.DistributedId;
...
/**
 * 分布式id生成
 * 1. 分布式id是通过美团的leaf生成的，是需要与ningxiang-leaf数据库 当中 leaf_alloc表中 biz_tag字段相关联的key
