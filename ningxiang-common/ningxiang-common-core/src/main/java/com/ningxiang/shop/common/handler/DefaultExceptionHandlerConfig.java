package com.ningxiang.shop.common.handler;
...
public class DefaultExceptionHandlerConfig {
	...
	@ExceptionHandler(NingxiangException.class)
	public ResponseEntity<ServerResponseEntity<Object>> ningxiangExceptionHandler(NingxiangException e) {
		logger.error("ningxiangExceptionHandler", e);
