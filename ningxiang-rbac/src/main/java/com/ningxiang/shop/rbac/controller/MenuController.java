...
import com.ningxiang.shop.rbac.dto.MenuDTO;
...
import com.ningxiang.shop.rbac.vo.RouteMetaVO;
import com.ningxiang.shop.rbac.vo.RouteVO;
...
public class MenuController {
	...
	private Menu checkAndGenerate(@RequestBody @Valid MenuDTO menuDTO) {
		...
		if(!Objects.equals(userInfoInTokenBO.getTenantId(),0L)){
			throw new NingxiangException("无权限操作！");
		}
