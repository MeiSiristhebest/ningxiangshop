...
const util = {
  ...
  getUserInfo: () => {
    ...
    return new Promise((resolve, reject) => {
      http.request({
        url: '/ningxiang_user/user/ma/user_detail_info',
        method: 'GET',
        dontTrunLogin: true
      }).then((res) => {
        resolve(res)
  ...
  refreshToken: () => {
    ...
    if (refreshToken && expiresTimeStamp && expiresTimeStamp < new Date().getTime()) {
      ...
      const params = {
        url: '/ningxiang_auth/ua/token/refresh',
        method: 'POST',
        isRefreshing: true,
        data: {
          refreshToken
  ...
  getAllinpayConfig: () => {
    const params = {
      url: '/ningxiang_admin/ua/app/sys_config/pay_settlement_type',
      method: 'GET'
    }
    http.request(params).then(res => {
      if (res) {
  ...
  getAllinpayMember: () => {
    const params = {
      url: '/ningxiang_payment/allinpay/member/get_user_info',
      method: 'GET',
  ...
  createAllinpayMember: () => {
    const params = {
      url: '/ningxiang_payment/allinpay/member/create_member',
      method: 'POST'
    }
    http.request(params)
  },
  ...
  loginByCode: (code) => {
    const params = {
      login: true,
      url: uni.getStorageSync('cloudAppType') === AppType.MINI ? '/ningxiang_auth/ua/social/ma' : '/ningxiang_auth/ua/social/mp',
      method: 'POST',
      data: code
    }
    http.request(params).then(res => {
  ...
  mioIoUpload: (imgItem, fn) => {
    const params = {
      url: '/ningxiang_biz/ua/oss/upload_minio',
      filePath: imgItem,
      name: 'file',
      callBack: res => {
  ...
  area: async (address, name) => {
    ...
    const getListByPid = (pid) => {
      return new Promise((resolve) => {
        const params = {
          url: '/ningxiang_order/area/list_by_pid',
          method: 'GET',
          data: {
            pid
          }
  ...
  getWebConfig: () => {
    const params = {
      url: '/ningxiang_admin/ua/web_config/get_activity',
      method: 'GET',
      data: {
  ...
  getTransactionId: (orderNumber) => {
    return new Promise(resolve => {
      http.request({
        url: `/ningxiang_order/my_order/check_trade_managed/${orderNumber}`,
        method: 'GET'
      }).then(res => {
  ...
  confirmReceipt: orderNumber => {
    http.request({
      url: `/ningxiang_order/my_order/receipt/${orderNumber}`,
      method: 'PUT'
    }).then(() => {
