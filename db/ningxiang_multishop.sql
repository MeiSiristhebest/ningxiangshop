...
MySQL - 8.0.25 : Database - ningxiang_multishop
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`ningxiang_multishop` /*!40100 DEFAULT CHARACTER SET utf8 */ /*!80016 DEFAULT ENCRYPTION='N' */;

USE `ningxiang_multishop`;
...
INSERT INTO `ningxiang_multishop`.`shop_detail` (`shop_id`, `create_time`, `update_time`, `shop_name`, `intro`, `shop_logo`, `mobile_background_pic`, `shop_status`, `business_license`, `identity_card_front`, `identity_card_later`, `type`) VALUES (0, '2022-04-25 14:49:45', '2022-04-25 14:50:35', 'lanhai', NULL, NULL, NULL, 1, '123456789123', '123456789123', NULL, 1);

INSERT INTO `ningxiang_multishop`.`shop_user` (`shop_user_id`, `create_time`, `update_time`, `shop_id`, `nick_name`, `code`, `phone_num`, `has_account`) VALUES (2, '2022-04-25 14:07:57', '2022-04-25 14:53:38', 0, 'hyg123', '', '18470778787', 1);
