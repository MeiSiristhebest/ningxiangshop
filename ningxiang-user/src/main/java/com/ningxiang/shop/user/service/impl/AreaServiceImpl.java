...
import com.ningxiang.shop.api.user.vo.AreaVO;
import com.ningxiang.shop.common.cache.constant.CacheNames;
import com.ningxiang.shop.common.exception.NingxiangException;
import com.ningxiang.shop.user.mapper.AreaMapper;
import com.ningxiang.shop.user.model.Area;
import com.ningxiang.shop.user.service.AreaService;
...
public class AreaServiceImpl implements AreaService {
    ...
    public void deleteById(Long areaId) {
        ...
        if (areaNum > 0) {
            throw new NingxiangException("请先删除子地区");
        }
