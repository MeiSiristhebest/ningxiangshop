package com.ningxiang.shop.payment.service.impl;
...
import com.ningxiang.shop.payment.bo.PayInfoBO;
import com.ningxiang.shop.payment.bo.PayInfoResultBO;
import com.ningxiang.shop.payment.constant.PayStatus;
import com.ningxiang.shop.payment.dto.PayInfoDTO;
import com.ningxiang.shop.payment.mapper.PayInfoMapper;
import com.ningxiang.shop.payment.model.PayInfo;
import com.ningxiang.shop.payment.service.PayInfoService;
...
public class PayInfoServiceImpl implements PayInfoService {
    ...
    public PayInfoBO pay(Long userId, PayInfoDTO payParam) {
        ...
        if (!ordersAmountAndIfNoCancelResponse.isSuccess()) {
            throw new NingxiangException(ordersAmountAndIfNoCancelResponse.getMsg());
        }
